...
public class BlocksForBuildersItems {
    ...
    public static final Item STRIPPED_COCONUT = registerItem("stripped_coconut", settings -> new BlockItem(BlocksForBuildersBlocks.COCONUT, settings.maxCount(64).food(new FoodComponent.Builder().nutrition(2).saturationModifier(0.3F).build())));
    ...
    public static final Item STRIPPED_EMPTY_COCONUT = registerItem("stripped_empty_coconut", settings -> new BlockItem(BlocksForBuildersBlocks.COCONUT, settings.maxCount(64).food(new FoodComponent.Builder().nutrition(2).saturationModifier(0.3F).build())));
