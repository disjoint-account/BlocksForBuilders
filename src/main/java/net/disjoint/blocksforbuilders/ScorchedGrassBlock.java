...
public class ScorchedGrassBlock extends Block implements Fertilizable {
    ...
    @Override
    public MapCodec<ScorchedGrassBlock> getCodec() {
        return CODEC;
    }

    public ScorchedGrassBlock(RegistryKey<ConfiguredFeature<?, ?>> feature, Settings settings) {
        super(settings);
