...
public class BlocksForBuilders implements ModInitializer {
	...
	public void onInitialize() {
		...
		Registry.register(Registry.BLOCK, new Identifier("blocksforbuilders", "fallen_sakura_leaves"), FALLEN_SAKURA_LEAVES);
		...
		Registry.register(Registry.BLOCK, new Identifier("blocksforbuilders", "fallen_green_jungle_leaves"), FALLEN_GREEN_JUNGLE_LEAVES);
		...
		Registry.register(Registry.BLOCK, new Identifier("blocksforbuilders", "fallen_ghostwood_leaves"), FALLEN_GHOSTWOOD_LEAVES);
		...
		Registry.register(Registry.BLOCK, new Identifier("blocksforbuilders", "fallen_red_oak_leaves"), FALLEN_RED_OAK_LEAVES);
		...
		Registry.register(Registry.ITEM, new Identifier("blocksforbuilders", "fallen_birch_leaves"), new BlockItem(FALLEN_BIRCH_LEAVES, new Item.Settings().group(BlocksForBuilders.BLOCKSFORBUILDERS)));
		Registry.register(Registry.BLOCK, new Identifier("blocksforbuilders", "fallen_spruce_leaves"), FALLEN_SPRUCE_LEAVES);
		Registry.register(Registry.ITEM, new Identifier("blocksforbuilders", "fallen_spruce_leaves"), new BlockItem(FALLEN_SPRUCE_LEAVES, new Item.Settings().group(BlocksForBuilders.BLOCKSFORBUILDERS)));
		Registry.register(Registry.BLOCK, new Identifier("blocksforbuilders", "fallen_jungle_leaves"), FALLEN_JUNGLE_LEAVES);
		Registry.register(Registry.ITEM, new Identifier("blocksforbuilders", "fallen_jungle_leaves"), new BlockItem(FALLEN_JUNGLE_LEAVES, new Item.Settings().group(BlocksForBuilders.BLOCKSFORBUILDERS)));
		Registry.register(Registry.BLOCK, new Identifier("blocksforbuilders", "fallen_dark_oak_leaves"), FALLEN_DARK_OAK_LEAVES);
		Registry.register(Registry.ITEM, new Identifier("blocksforbuilders", "fallen_dark_oak_leaves"), new BlockItem(FALLEN_DARK_OAK_LEAVES, new Item.Settings().group(BlocksForBuilders.BLOCKSFORBUILDERS)));
		Registry.register(Registry.BLOCK, new Identifier("blocksforbuilders", "fallen_acacia_leaves"), FALLEN_ACACIA_LEAVES);
		Registry.register(Registry.ITEM, new Identifier("blocksforbuilders", "fallen_acacia_leaves"), new BlockItem(FALLEN_ACACIA_LEAVES, new Item.Settings().group(BlocksForBuilders.BLOCKSFORBUILDERS)));
		Registry.register(Registry.BLOCK, new Identifier("blocksforbuilders", "fallen_azalea_leaves"), FALLEN_AZALEA_LEAVES);
		Registry.register(Registry.ITEM, new Identifier("blocksforbuilders", "fallen_azalea_leaves"), new BlockItem(FALLEN_AZALEA_LEAVES, new Item.Settings().group(BlocksForBuilders.BLOCKSFORBUILDERS)));
		Registry.register(Registry.BLOCK, new Identifier("blocksforbuilders", "fallen_flowering_azalea_leaves"), FALLEN_FLOWERING_AZALEA_LEAVES);
		Registry.register(Registry.ITEM, new Identifier("blocksforbuilders", "fallen_flowering_azalea_leaves"), new BlockItem(FALLEN_FLOWERING_AZALEA_LEAVES, new Item.Settings().group(BlocksForBuilders.BLOCKSFORBUILDERS)));
		Registry.register(Registry.BLOCK, new Identifier("blocksforbuilders", "fallen_mangrove_leaves"), FALLEN_MANGROVE_LEAVES);
		Registry.register(Registry.ITEM, new Identifier("blocksforbuilders", "fallen_mangrove_leaves"), new BlockItem(FALLEN_MANGROVE_LEAVES, new Item.Settings().group(BlocksForBuilders.BLOCKSFORBUILDERS)));
